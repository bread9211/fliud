local shaders = {
    ["face.vert"] = [[attribute vec3 position;
    uniform vec2 px;
    ...
    ["line.vert"] = [[attribute vec3 position;
    varying vec2 uv;
    uniform vec2 px;
    ...
    ["mouse.vert"] = [[precision highp float;
    ...
    ["advection.frag"] = [[precision highp float;
    ...
    ["viscous.frag"] = [[precision highp float;
    uniform sampler2D velocity;
